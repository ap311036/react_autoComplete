...
class Demo extends Component {
    ...
    render () {
        return (
            <div>
                <h1 style={{ margin: '15px 0px'}}>Style:單程雙月曆</h1>
                <div style={{ width: '170px'}}>
                    <div
                        onClick={e => {
                            let oneWayDate = '';
                            let doubleWayStartDate = '';
                            let doubleWayBackDate = '2018/04/24';
                            this.setState({ oneWayDate, doubleWayStartDate, doubleWayBackDate });
                        }}
                    >
                        Click Me Change Date
                    </div>
                    <CyRnmb
                        mode="oneWay"
                        isShowIcon
                ...
                <CyRnmb
                    ...
                    mode="doubleWay"
                    isDays
                    labelStartDateText="去程日期"
                    labelBackDateText="回程日期"
                    defaultStartDate="2018/04/28"
                    defaultEndDate="2018/04/30"
                    minDate="2018/04/03"
                    maxDate={moment().add(4, 'months').format('YYYY/MM/DD')}
