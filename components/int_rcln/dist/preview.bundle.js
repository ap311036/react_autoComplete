...
/******/ 	var hotCurrentHash = "81c78685bbc6ebab2fe9"; // eslint-disable-line no-unused-vars
...
var _objectUnfreeze = __webpack_require__(105);

var _objectUnfreeze2 = _interopRequireDefault(_objectUnfreeze);

var _isIterable = __webpack_require__(106);

var _isIterable2 = _interopRequireDefault(_isIterable);

var _parseStyleName = __webpack_require__(107);

var _parseStyleName2 = _interopRequireDefault(_parseStyleName);

var _generateAppendClassName = __webpack_require__(184);
...
var _ic_rcln = __webpack_require__(77);
...
var changeCallBack = function changeCallBack(e, data) {
    console.log('changeCallBack', data);
};

var blurCallBack = function blurCallBack(e, data) {
...
var Test = function (_React$Component) {
    ...
    function Test() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Test.__proto__ || Object.getPrototypeOf(Test)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, 'state', {
            enumerable: true,
            writable: true,
            value: {
                count: 1
        ...
        }), Object.defineProperty(_this, 'handleClick2', {
            enumerable: true,
            writable: true,
            value: function value() {
                _this.setState({
    ...
    _createClass(Test, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Module2.default, { placeholder: 'text some..', className: 'custom',
                    value: 'loooooooooooooooooongloooooooooooooooooongloooooooooooooooooongloooooooooooooooooong',
                    readOnly: true,
                    color: 'blue',
                    onBlur: function onBlur(e, data) {
                    ...
                    breakline: true,
                    icon: _react2.default.createElement(_ic_rcln2.default, { name: 'tooldate' })
                }),
                _react2.default.createElement(
                    'button',
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', disabled: true }),
    _react2.default.createElement(
        'h2',
        null,
        'color: error, success, blue'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', color: 'error' }),
    _react2.default.createElement('br', null),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', color: 'success',
        onKeyDown: function onKeyDown(a, b) {
            // console.log('keydown', a, b);
        },
        onKeyPress: function onKeyPress(a, b) {
        ...
        onCompositionStart: function onCompositionStart(a, b) {
            console.log('onCompositionStart', a.target, a.type, b);
        },
        onCompositionUpdate: function onCompositionUpdate(a, b) {
            console.log('onCompositionUpdate', a.target, a.type, b);
        },
        onCompositionEnd: function onCompositionEnd(a, b) {
            console.log('onCompositionEnd', a.target, a.type, b);
        }
    }),
    _react2.default.createElement('br', null),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', color: 'blue' }),
    _react2.default.createElement(
        'h2',
        null,
        'onChange, onBlur(event: SyntheticEvent, data: value)'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', onChange: changeCallBack, onBlur: blurCallBack }),
    _react2.default.createElement(
        'h2',
        null,
        'label'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', label: 'very loooooooooooooooooong label' }),
    _react2.default.createElement('br', null),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', label: 'short label' }),
    _react2.default.createElement(
        'h2',
        null,
        'breakline'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', label: '\u6211\u662F\u6A19\u984C', breakline: true }),
    _react2.default.createElement(
        'h2',
        null,
        'icon'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', label: '\u6211\u662F\u6A19\u984C', icon: _react2.default.createElement(_ic_rcln2.default, { name: 'tooldate' }) }),
    _react2.default.createElement(
        'h2',
        null,
        'icon without label'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', icon: _react2.default.createElement(_ic_rcln2.default, { name: 'tooldate' }) }),
    _react2.default.createElement(
        'h2',
        null,
        'readOnly'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', defaultValue: '\u6E2C\u8A66', readOnly: true }),
    _react2.default.createElement(
        'h2',
        null,
        'noBorder'
    ),
    _react2.default.createElement(_Module2.default, { placeholder: 'text some..', noBorder: true }),
    _react2.default.createElement(
        'h2',
        null,
        'request'
    ),
    _react2.default.createElement(_Module2.default, { request: true, label: '\u6211\u662F\u6A19\u984C', breakline: true })
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Module.__proto__ || Object.getPrototypeOf(Module)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, 'handleChange', {
            ...
            value: function value(e) {
                if (_this.props.onKeyPress) {
                    _this.props.onKeyPress(e, e.target.value);
                }
            }
            ...
            value: function value(e) {
                if (_this.props.onKeyDown) {
                    _this.props.onKeyDown(e, e.target.value);
                }
            }
        }), Object.defineProperty(_this, 'handleKeyUp', {
            enumerable: true,
            writable: true,
            value: function value(e) {
                if (_this.props.onKeyUp) {
                    _this.props.onKeyUp(e, e.target.value);
                }
            }
        }), Object.defineProperty(_this, 'handleCompositionStart', {
            enumerable: true,
            writable: true,
            value: function value(e) {
                if (_this.props.onCompositionStart) {
                    _this.props.onCompositionStart(e, e.target.value);
                }
            }
        }), Object.defineProperty(_this, 'handleCompositionUpdate', {
            enumerable: true,
            writable: true,
            value: function value(e) {
                if (_this.props.onCompositionUpdate) {
                    _this.props.onCompositionUpdate(e, e.target.value);
                }
            }
        }), Object.defineProperty(_this, 'handleCompositionEnd', {
            enumerable: true,
            writable: true,
            value: function value(e) {
                if (_this.props.onCompositionEnd) {
                    _this.props.onCompositionEnd(e, e.target.value);
                }
            }
            ...
            value: function value() {
                ...
                if (readOnly && !disabled) {
                    ...
                    return _react2.default.createElement('input', {
                        ...
                        onCompositionUpdate: _this.handleCompositionUpdate,
                        value: value,
                        readOnly: readOnly
                    });
                }
...
var _reactCssModules = __webpack_require__(83);

var _reactCssModules2 = _interopRequireDefault(_reactCssModules);

var _css = __webpack_require__(208);
...
var _extendReactClass = __webpack_require__(87);

var _extendReactClass2 = _interopRequireDefault(_extendReactClass);

var _wrapStatelessFunction = __webpack_require__(186);

var _wrapStatelessFunction2 = _interopRequireDefault(_wrapStatelessFunction);

var _makeConfiguration = __webpack_require__(198);
...
var _trim2 = __webpack_require__(172);
...
var baseToString = __webpack_require__(58),
    castSlice = __webpack_require__(173),
...
var asciiToArray = __webpack_require__(181),
...
var _SimpleMap = __webpack_require__(185);
...
var _includes2 = __webpack_require__(199);
